...
| Task   | ブランチ                    | 対応 Issue | 内容                          | 状態  |
| ------ | ----------------------- | -------- | --------------------------- | --- |
| R10-T1 | `r10/t1-gem-update`     | —        | gem を入手できる最新の版へ上げる          | 進行中 |
| R10-T2 | `r10/t2-action-update`  | —        | GitHub Actions の参照を最新の版へ上げる | 未着手 |
| R10-T3 | `r10/t3-bundler-update` | —        | 依存を解決する道具の系列を上げる            | 未着手 |
