...
| Task  | ブランチ                        | 対応 Issue | 内容                          | 状態  |
| ----- | --------------------------- | -------- | --------------------------- | --- |
| R1-T1 | `r1/t1-backup-retention`    | —        | 取得した書庫の保持の上限を設ける            | 進行中 |
| R1-T2 | `r1/t2-backup-encryption`   | —        | 書庫を暗号化して取得し、同じ経路で復元する       | 未着手 |
| R1-T3 | `r1/t3-scheduled-backup`    | —        | 時刻起動から無人で取得できるようにする         | 未着手 |
