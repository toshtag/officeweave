...
| Task  | ブランチ                          | 対応 Issue | 内容                            | 状態  |
| ----- | ----------------------------- | -------- | ----------------------------- | --- |
| R2-T1 | `r2/t1-password-change`       | —        | 自分でパスワードを変更できるようにする           | 進行中 |
| R2-T2 | `r2/t2-password-reset`        | —        | パスワードの再設定を用意する                | 未着手 |
| R2-T3 | `r2/t3-session-management`    | —        | 自分のログインを一覧し、まとめて終わらせる         | 未着手 |
