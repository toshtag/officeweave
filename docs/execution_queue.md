...
| Task   | ブランチ                    | 対応 Issue | 内容                     | 状態  |
| ------ | ----------------------- | -------- | ---------------------- | --- |
| R11-T1 | `r11/t1-container-names` | —        | 表示される名称と一覧の項目数を減らす     | 進行中 |
| R11-T2 | `r11/t2-image-build`    | —        | 組み立ての無駄を取り除く           | 未着手 |
| R11-T3 | `r11/t3-startup-wait`   | —        | 起動の待ち時間を詰める            | 未着手 |
| R11-T4 | `r11/t4-leftovers`      | —        | 立ち上げるたびに残るものを無くす       | 未着手 |
