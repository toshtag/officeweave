...
現在の Phase: R0
直近完了 Task: R0-T31
進行中:        R0-T32 お知らせ一覧の 3 区分で作成者の読み込みをそろえる（#124）
次に実行:      R0-T33 性能レビュー分の完了確認
```
...
| R0-T32 | `r0/t32-announcement-author-preload` | [#124](https://github.com/toshtag/OfficeWeave/issues/124) | お知らせ一覧の 3 区分で作成者の読み込みをそろえる | 進行中 |
