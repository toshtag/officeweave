...
| Task  | ブランチ                          | 対応 Issue | 内容                        | 状態  |
| ----- | ----------------------------- | -------- | ------------------------- | --- |
| R4-T1 | `r4/t1-list-pagination`       | —        | 一覧のページ送りを共通化する            | 進行中 |
| R4-T2 | `r4/t2-list-filters`          | —        | 一覧の絞り込みを用意する              | 未着手 |
| R4-T3 | `r4/t3-api-paging`            | —        | API のページングとレート制限を設ける      | 未着手 |
| R4-T4 | `r4/t4-search-scope`          | —        | 検索の対象を広げる                 | 未着手 |
